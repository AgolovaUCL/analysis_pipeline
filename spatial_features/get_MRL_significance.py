...
import random
from get_sig_cells import get_sig_cells # CHECK IF WORKS
...
def get_MRL_significance(derivatives_base, rawsession_folder, trials_to_include, frame_rate = 25, sample_rate = 30000, num_bins = 24):
    """
