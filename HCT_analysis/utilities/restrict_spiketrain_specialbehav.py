...
def restrict_spiketrain_specialbehav(spike_train, rawsession_folder, goal: int):
    ...
    if goal == 0:
        ...
        intervals_0 = list(zip(intervals_df_restr.iloc[:,0], intervals_df_restr.iloc[:,1]))
        ...
        # Convert to list of tuples
        intervals_2 = list(zip(intervals_df_restr.iloc[:,0], intervals_df_restr.iloc[:,1]))
        
        intervals = intervals_0 + intervals_2
