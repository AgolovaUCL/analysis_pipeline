...
def calculate_popsink(derivatives_base, unit_type, title = 'Population Sinks', frame_rate = 25, sample_rate = 30000, code_to_run = []):
    """
    ...
    # To load data
    data_folder = os.path.join(derivatives_base, 'analysis', 'cell_characteristics', 'spatial_features', 'consink_data_newmethod')
    ...
    if 1 in code_to_run:
        ...
        # Here g == 0 corresponds to the whole session, not split into goals
            ...
            relDirDist= calculate_relDirDist(pos_data_iv,  sink_bins, direction_bins)# Have to rewrite function for that
...
if __name__ == "__main__":
    ...
    calculate_popsink(derivatives_base, unit_type = 'pyramidal', code_to_run = [1, 2], title = 'Popsink Pyramidal w padding intervals', frame_rate = 25, sample_rate = 30000)
